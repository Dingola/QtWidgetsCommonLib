# Qt Widgets Common Lib

## 🚀 [Build Status]

### 🛠 Build and ✅ Test

[![Linux Build and Test](https://github.com/Dingola/QtWidgetsCommonLib/actions/workflows/build_and_test_linux.yml/badge.svg)](https://github.com/Dingola/QtWidgetsCommonLib/actions/workflows/build_and_test_linux.yml)
[![macOS Build and Test](https://github.com/Dingola/QtWidgetsCommonLib/actions/workflows/build_and_test_macos.yml/badge.svg)](https://github.com/Dingola/QtWidgetsCommonLib/actions/workflows/build_and_test_macos.yml)
[![Windows Build and Test](https://github.com/Dingola/QtWidgetsCommonLib/actions/workflows/build_and_test_windows.yml/badge.svg)](https://github.com/Dingola/QtWidgetsCommonLib/actions/workflows/build_and_test_windows.yml)

### Code Coverage

[![codecov](https://codecov.io/github/Dingola/QtWidgetsCommonLib/graph/badge.svg?token=6N412JSJ2P)](https://codecov.io/github/Dingola/QtWidgetsCommonLib)
...
## [Description]
**QtWidgetsCommonLib** is a specialized foundational library designed to streamline the development
of **Qt Widget-based desktop applications**. It serves as a shared toolkit containing reusable services,
utilities, and custom UI components that are essential for modern desktop interfaces.

The solution is divided into two parts: the main project and a test project. By default, only the
...
The project configuration supports documentation generation with Doxygen and includes GitHub
workflows (CI builds) for Mac, Linux and Windows.
<br><br>
...
|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| **Sunburst** | The inner-most circle represents the entire project. Moving outward are folders, and finally individual files. The size and color of each slice represent the number of statements and the coverage, respectively. | <img src="https://codecov.io/github/Dingola/QtWidgetsCommonLib/graphs/sunburst.svg?token=6N412JSJ2P" alt="Sunburst" height="100" width="200"> |
| **Grid**     | Each block represents a single file in the project. The size and color of each block represent the number of statements and the coverage, respectively.                                                                      | <img src="https://codecov.io/github/Dingola/QtWidgetsCommonLib/graphs/tree.svg?token=6N412JSJ2P" alt="Grid" height="100" width="200">         |
| **Icicle**   | The top section represents the entire project, followed by folders and individual files. The size and color of each slice represent the number of statements and the coverage, respectively.                                 | <img src="https://codecov.io/github/Dingola/QtWidgetsCommonLib/graphs/icicle.svg?token=6N412JSJ2P" alt="Icicle" height="150" width="400">     |
...
### 2) Setting up
```
git clone https://github.com/Dingola/QtWidgetsCommonLib.git
cd QtWidgetsCommonLib/
```
<br>
...
### 4) Run the project
```
cd QtWidgetsCommonLib/Release/
./QtWidgetsCommonLib.exe
```
<br>
...
```
docker build -t qtwidgetscommonlib-dockerimage .
```
<br>
...
- **Run directly:**
```
docker run qtwidgetscommonlib-dockerimage
```
- **Start an interactive Bash shell:**
```
docker run -it qtwidgetscommonlib-dockerimage bash
```
<br>
...
```
Xvfb :99 -screen 0 1920x1080x24 -nolisten tcp & export DISPLAY=:99 && ./_build_app_release/QT_Project/QtWidgetsCommonLib
```
- **Run the tests (virtual display with Xvfb):**
```
Xvfb :99 -screen 0 1920x1080x24 -nolisten tcp & export DISPLAY=:99 && ./_build_tests_release/QT_Project_Tests/QtWidgetsCommonLib_Tests
```
<br>
...
```
docker run -it --name QtWidgetsCommonLib-Container --network host -e DISPLAY=<IP-ADDRESS>:99.0 -e TERM=xterm-256color -e QT_X11_NO_MITSHM=1 QtWidgetsCommonLib-DockerImage bash
```
> [!NOTE]
...
- **Start the app:**
```
"./_build_app_release/QT_Project/QtWidgetsCommonLib"
```
- **Run the tests:**
```
"./_build_tests_release/QT_Project_Tests/QtWidgetsCommonLib_Tests"
```
<br>
...
## [Translations]
The project includes custom targets for updating and compiling translation files. These targets are defined in the CMake file located in `QtWidgetsCommonLib/QT_Project` and can be used to manage translation files located in the `QtWidgetsCommonLib/QT_Project/resources/Translations` directory.
